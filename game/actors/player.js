...
function LevelDB(owner) {
    ...
    this.turretPower = new LevelProperty("Turret Fire Power", 5, 3)
    this.turretRate = new LevelProperty("Turret Fire Rate", 6, 3)
    this.turretSlots = new LevelProperty("Max no. of turrets", 8, 8, 8)
